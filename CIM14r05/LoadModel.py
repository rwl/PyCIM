...
from CIM14r05.Wires import EnergyConsumer
...
class LoadGroup(IdentifiedObject):
    ...
    SubLoadArea = Instance("CIM14r05.LoadModel.SubLoadArea",
        transient=True,
        opposite="LoadGroups",
        ...
        if self.Parent is not None:
            return [e for e in self.Parent.Elements \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM14r05.LoadModel.SubLoadArea" ]
        else:
            return []
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "SubLoadArea",
                label="References"),
            dock="tab"),
        id="CIM14r05.LoadModel.LoadGroup",
        title="LoadGroup",
...
class NonConformLoad(EnergyConsumer):
    ...
    LoadGroup = Instance("CIM14r05.LoadModel.NonConformLoadGroup",
        transient=True,
    ...
    def _get_nonconformloadgroups(self):
        ...
        if self.Parent is not None:
            return [e for e in self.Parent.Elements \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM14r05.LoadModel.NonConformLoadGroup" ]
        else:
            return []
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "OperatingShare", "OperatedBy_Companies", "PSRType", "PsrLists", "ReportingGroup", "OutageSchedule", "Contains_Measurements", "MemberOf_EquipmentContainer", "OperationalLimitSet", "ContingencyEquipment", "ProtectionEquipments", "SvStatus", "Terminals", "BaseVoltage", "ClearanceTags", "LoadResponse", "PowerCutZone", "LoadGroup",
                label="References", columns=2),
            dock="tab"),
        id="CIM14r05.LoadModel.NonConformLoad",
...
class LoadResponseCharacteristic(IdentifiedObject):
    ...
    EnergyConsumer = List(Instance("CIM14r05.Wires.EnergyConsumer"))
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "pConstantImpedance", "qConstantPower", "pFrequencyExponent", "exponentModel", "pConstantCurrent", "qFrequencyExponent", "qConstantCurrent", "qConstantImpedance", "pConstantPower", "pVoltageExponent", "qVoltageExponent",
                label="Attributes", columns=1),
            VGroup("Parent", "ModelingAuthoritySet", "EnergyConsumer",
                label="References"),
            dock="tab"),
        id="CIM14r05.LoadModel.LoadResponseCharacteristic",
...
class DayType(IdentifiedObject):
    ...
    SeasonDayTypeSchedules = List(Instance("CIM14r05.LoadModel.SeasonDayTypeSchedule"),
...
class ConformLoad(EnergyConsumer):
    ...
    LoadGroup = Instance("CIM14r05.LoadModel.ConformLoadGroup",
    ...
    def _get_conformloadgroups(self):
        ...
        if self.Parent is not None:
            return [e for e in self.Parent.Elements \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM14r05.LoadModel.ConformLoadGroup" ]
        else:
            return []
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "OperatingShare", "OperatedBy_Companies", "PSRType", "PsrLists", "ReportingGroup", "OutageSchedule", "Contains_Measurements", "MemberOf_EquipmentContainer", "OperationalLimitSet", "ContingencyEquipment", "ProtectionEquipments", "SvStatus", "Terminals", "BaseVoltage", "ClearanceTags", "LoadResponse", "PowerCutZone", "LoadGroup",
                label="References", columns=2),
            dock="tab"),
        id="CIM14r05.LoadModel.ConformLoad",
        title="ConformLoad",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class PowerCutZone(PowerSystemResource):
    ...
    EnergyConsumers = List(Instance("CIM14r05.Wires.EnergyConsumer"),
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "cutLevel2", "cutLevel1",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "OperatingShare", "OperatedBy_Companies", "PSRType", "PsrLists", "ReportingGroup", "OutageSchedule", "Contains_Measurements", "EnergyConsumers",
                label="References"),
            dock="tab"),
        id="CIM14r05.LoadModel.PowerCutZone",
        title="PowerCutZone",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class SeasonDayTypeSchedule(RegularIntervalSchedule):
    ...
    # Load demand models can be based on day type
    DayType = Instance("CIM14r05.LoadModel.DayType",
        desc="Load demand models can be based on day type",
        transient=True,
    ...
    Season = Instance("CIM14r05.LoadModel.Season",
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "TimePoints", "DayType", "Season",
                label="References"),
            dock="tab"),
        id="CIM14r05.LoadModel.SeasonDayTypeSchedule",
...
class StationSupply(EnergyConsumer):
    ...
    traits_view = View(Tabbed(
            ...
            dock="tab"),
        id="CIM14r05.LoadModel.StationSupply",
        title="StationSupply",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class EnergyArea(IdentifiedObject):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "ControlArea",
                label="References"),
            dock="tab"),
        id="CIM14r05.LoadModel.EnergyArea",
        title="EnergyArea",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class Season(Element):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("endDate", "startDate", "name",
                label="Attributes"),
            VGroup("Parent", "SeasonDayTypeSchedules",
                label="References"),
            dock="tab"),
        id="CIM14r05.LoadModel.Season",
        title="Season",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class NonConformLoadSchedule(SeasonDayTypeSchedule):
    ...
    NonConformLoadGroup = Instance("CIM14r05.LoadModel.NonConformLoadGroup",
        transient=True,
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "TimePoints", "DayType", "Season", "NonConformLoadGroup",
                label="References"),
            dock="tab"),
        id="CIM14r05.LoadModel.NonConformLoadSchedule",
...
class ConformLoadSchedule(SeasonDayTypeSchedule):
    ...
    ConformLoadGroup = Instance("CIM14r05.LoadModel.ConformLoadGroup",
        transient=True,
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "TimePoints", "DayType", "Season", "ConformLoadGroup",
                label="References"),
            dock="tab"),
        id="CIM14r05.LoadModel.ConformLoadSchedule",
...
class SubLoadArea(EnergyArea):
    ...
    LoadArea = Instance("CIM14r05.LoadModel.LoadArea",
    ...
    def _get_loadareas(self):
        ...
        if self.Parent is not None:
            return [e for e in self.Parent.Elements \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM14r05.LoadModel.LoadArea" ]
        else:
            return []

    _loadareas = Property(fget=_get_loadareas)

    LoadGroups = List(Instance("CIM14r05.LoadModel.LoadGroup"))
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "ControlArea", "LoadArea", "LoadGroups",
                label="References"),
            dock="tab"),
        id="CIM14r05.LoadModel.SubLoadArea",
        title="SubLoadArea",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class ConformLoadGroup(LoadGroup):
    ...
    ConformLoadSchedules = List(Instance("CIM14r05.LoadModel.ConformLoadSchedule"))

    # Consumers may be assigned to a load area.
    EnergyConsumers = List(Instance("CIM14r05.LoadModel.ConformLoad"),
        desc="Consumers may be assigned to a load area.")
    ...
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "SubLoadArea", "ConformLoadSchedules", "EnergyConsumers",
                label="References"),
            dock="tab"),
        id="CIM14r05.LoadModel.ConformLoadGroup",
...
class CustomerLoad(ConformLoad):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "OperatingShare", "OperatedBy_Companies", "PSRType", "PsrLists", "ReportingGroup", "OutageSchedule", "Contains_Measurements", "MemberOf_EquipmentContainer", "OperationalLimitSet", "ContingencyEquipment", "ProtectionEquipments", "SvStatus", "Terminals", "BaseVoltage", "ClearanceTags", "LoadResponse", "PowerCutZone", "LoadGroup",
                label="References", columns=2),
            dock="tab"),
        id="CIM14r05.LoadModel.CustomerLoad",
        title="CustomerLoad",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class LoadArea(EnergyArea):
    ...
    # The SubLoadAreas in the LoadArea.
    SubLoadAreas = List(Instance("CIM14r05.LoadModel.SubLoadArea"),
        desc="The SubLoadAreas in the LoadArea.")
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "ControlArea", "SubLoadAreas",
                label="References"),
            dock="tab"),
        id="CIM14r05.LoadModel.LoadArea",
        title="LoadArea",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class Load(ConformLoad):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "equivalent", "normalIlyInService", "phases", "pfixed", "pfixedPct", "qfixed", "customerCount", "qfixedPct", "feederLoadMgtFactor", "coldPickUpFactorP", "phaseRatedCurrent", "coldPickUpFactorQ", "loadAllocationFactor",
                label="Attributes", columns=1),
            VGroup("Parent", "ModelingAuthoritySet", "OperatingShare", "OperatedBy_Companies", "PSRType", "PsrLists", "ReportingGroup", "OutageSchedule", "Contains_Measurements", "MemberOf_EquipmentContainer", "OperationalLimitSet", "ContingencyEquipment", "ProtectionEquipments", "SvStatus", "Terminals", "BaseVoltage", "ClearanceTags", "LoadResponse", "PowerCutZone", "LoadGroup",
                label="References", columns=2),
            dock="tab"),
        id="CIM14r05.LoadModel.Load",
        title="Load",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class NonConformLoadGroup(LoadGroup):
    ...
    EnergyConsumers = List(Instance("CIM14r05.LoadModel.NonConformLoad"))

    NonConformLoadSchedules = List(Instance("CIM14r05.LoadModel.NonConformLoadSchedule"))
    ...
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "SubLoadArea", "EnergyConsumers", "NonConformLoadSchedules",
                label="References"),
            dock="tab"),
        id="CIM14r05.LoadModel.NonConformLoadGroup",
...
class InductionMotorLoad(NonConformLoad):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "OperatingShare", "OperatedBy_Companies", "PSRType", "PsrLists", "ReportingGroup", "OutageSchedule", "Contains_Measurements", "MemberOf_EquipmentContainer", "OperationalLimitSet", "ContingencyEquipment", "ProtectionEquipments", "SvStatus", "Terminals", "BaseVoltage", "ClearanceTags", "LoadResponse", "PowerCutZone", "LoadGroup",
                label="References", columns=2),
            dock="tab"),
        id="CIM14r05.LoadModel.InductionMotorLoad",
