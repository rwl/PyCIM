...
from CIM14r05.SCADA import Source
...
Validity = Enum("QUESTIONABLE", "INVALID", "GOOD")
...
class LimitSet(IdentifiedObject):
    ...
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "isPercentageLimits",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.LimitSet",
        title="LimitSet",
...
class ValueAliasSet(IdentifiedObject):
    ...
    Values = List(Instance("CIM14r05.Meas.ValueToAlias"))

    Measurements = List(Instance("CIM14r05.Meas.Discrete"))

    Commands = List(Instance("CIM14r05.Meas.Command"))
    ...
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "Values", "Measurements", "Commands",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.ValueAliasSet",
        title="ValueAliasSet",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class Measurement(IdentifiedObject):
    ...
    MeasurementType = Instance("CIM14r05.Meas.MeasurementType",
    ...
    MemberOf_PSR = Instance("CIM14r05.Core.PowerSystemResource",
    ...
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "Unit", "MeasurementType", "MemberOf_PSR", "Terminal",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.Measurement",
        title="Measurement",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class MeasurementValueSource(IdentifiedObject):
    ...
    MeasurementValues = List(Instance("CIM14r05.Meas.MeasurementValue"))
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "MeasurementValues",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.MeasurementValueSource",
...
class Quality61850(Element):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("outOfRange", "overFlow", "oscillatory", "oldData", "validity", "failure", "operatorBlocked", "estimatorReplaced", "suspect", "test", "source", "badReference",
                label="Attributes"),
            VGroup("Parent",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.Quality61850",
        title="Quality61850",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class Control(IdentifiedObject):
    ...
    ControlType = Instance("CIM14r05.Meas.ControlType",
        transient=True,
        opposite="Controls",
    ...
    ControlledBy_RegulatingCondEq = Instance("CIM14r05.Wires.RegulatingCondEq",
    ...
    def _get_regulatingcondeqs(self):
        ...
        if self.Parent is not None:
            return [e for e in self.Parent.Elements \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM14r05.Wires.RegulatingCondEq" ]
        else:
            return []

    _regulatingcondeqs = Property(fget=_get_regulatingcondeqs)

    RemoteControl = Instance("CIM14r05.SCADA.RemoteControl",
        transient=True,
        opposite="Control",
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "operationInProgress", "timeStamp",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "ControlType", "ControlledBy_RegulatingCondEq", "RemoteControl", "Unit",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.Control",
        title="Control",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class ValueToAlias(IdentifiedObject):
    ...
    ValueAliasSet = Instance("CIM14r05.Meas.ValueAliasSet",
        transient=True,
        opposite="Values",
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "value",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "ValueAliasSet",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.ValueToAlias",
        title="ValueToAlias",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class MeasurementType(IdentifiedObject):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "Measurements",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.MeasurementType",
...
class MeasurementValue(IdentifiedObject):
    ...
    RemoteSource = Instance("CIM14r05.SCADA.RemoteSource",
    ...
    MeasurementValueQuality = Instance("CIM14r05.Meas.MeasurementValueQuality",
    ...
    def _get_measurementvaluequalitys(self):
        ...
        if self.Parent is not None:
            return [e for e in self.Parent.Elements \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM14r05.Meas.MeasurementValueQuality" ]
        else:
            return []

    _measurementvaluequalitys = Property(fget=_get_measurementvaluequalitys)

    MeasurementValueSource = Instance("CIM14r05.Meas.MeasurementValueSource",
        transient=True,
    ...
    def _get_measurementvaluesources(self):
        ...
        if self.Parent is not None:
            return [e for e in self.Parent.Elements \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM14r05.Meas.MeasurementValueSource" ]
        else:
            return []
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "sensorAccuracy", "timeStamp",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "RemoteSource", "MeasurementValueQuality", "MeasurementValueSource",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.MeasurementValue",
...
class AccumulatorValue(MeasurementValue):
    ...
    MemberOf_Measurement = Instance("CIM14r05.Meas.Accumulator",
        transient=True,
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "sensorAccuracy", "timeStamp", "value",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "RemoteSource", "MeasurementValueQuality", "MeasurementValueSource", "MemberOf_Measurement",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.AccumulatorValue",
...
class AnalogLimitSet(LimitSet):
    ...
    Measurements = List(Instance("CIM14r05.Meas.Analog"),
        desc="A measurement may have zero or more limit ranges defined for it.")

    Limits = List(Instance("CIM14r05.Meas.AnalogLimit"))
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "Measurements", "Limits",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.AnalogLimitSet",
...
class AnalogValue(MeasurementValue):
    ...
    MemberOf_Measurement = Instance("CIM14r05.Meas.Analog",
        transient=True,
        opposite="Contain_MeasurementValues",
    ...
    def _get_analogs(self):
        ...
        if self.Parent is not None:
            return [e for e in self.Parent.Elements \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM14r05.Meas.Analog" ]
        else:
            return []

    _analogs = Property(fget=_get_analogs)

    AltGeneratingUnit = List(Instance("CIM14r05.ControlArea.AltGeneratingUnitMeas"))

    AltTieMeas = List(Instance("CIM14r05.ControlArea.AltTieMeas"))
    ...
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "sensorAccuracy", "timeStamp", "value",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "RemoteSource", "MeasurementValueQuality", "MeasurementValueSource", "MemberOf_Measurement", "AltGeneratingUnit", "AltTieMeas",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.AnalogValue",
        title="AnalogValue",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class SetPoint(Control):
    ...
    MeasuredBy_Measurement = Instance("CIM14r05.Meas.Analog",
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "operationInProgress", "timeStamp", "minValue", "value", "maxValue", "normalValue",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "ControlType", "ControlledBy_RegulatingCondEq", "RemoteControl", "Unit", "MeasuredBy_Measurement",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.SetPoint",
        title="SetPoint",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class DiscreteValue(MeasurementValue):
    ...
    MemberOf_Measurement = Instance("CIM14r05.Meas.Discrete",
        transient=True,
        opposite="Contain_MeasurementValues",
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "RemoteSource", "MeasurementValueQuality", "MeasurementValueSource", "MemberOf_Measurement",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.DiscreteValue",
        title="DiscreteValue",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class AccumulatorLimitSet(LimitSet):
    ...
    Limits = List(Instance("CIM14r05.Meas.AccumulatorLimit"))

    # A measurement may have zero or more limit ranges defined for it.
    Measurements = List(Instance("CIM14r05.Meas.Accumulator"),
        desc="A measurement may have zero or more limit ranges defined for it.")
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "Limits", "Measurements",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.AccumulatorLimitSet",
...
class MeasurementValueQuality(Quality61850):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "MeasurementValue",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.MeasurementValueQuality",
...
class Discrete(Measurement):
    ...
    Contain_MeasurementValues = List(Instance("CIM14r05.Meas.DiscreteValue"))
    ...
    ControlledBy_Control = Instance("CIM14r05.Meas.Command",
        transient=True,
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "maxValue", "normalValue", "minValue",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "Unit", "MeasurementType", "MemberOf_PSR", "Terminal", "Contain_MeasurementValues", "ValueAliasSet", "ControlledBy_Control",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.Discrete",
        title="Discrete",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class AnalogLimit(Limit):
    ...
    LimitSet = Instance("CIM14r05.Meas.AnalogLimitSet",
        transient=True,
        opposite="Limits",
...
class Accumulator(Measurement):
    ...
    # A measurement may have zero or more limit ranges defined for it.
    LimitSets = List(Instance("CIM14r05.Meas.AccumulatorLimitSet"),
        desc="A measurement may have zero or more limit ranges defined for it.")

    Contain_MeasurementValues = List(Instance("CIM14r05.Meas.AccumulatorValue"))
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "maxValue",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "Unit", "MeasurementType", "MemberOf_PSR", "Terminal", "LimitSets", "Contain_MeasurementValues",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.Accumulator",
        title="Accumulator",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class StringMeasurementValue(MeasurementValue):
    ...
    MemberOf_Measurement = Instance("CIM14r05.Meas.StringMeasurement",
        transient=True,
    ...
    def _get_stringmeasurements(self):
        ...
        if self.Parent is not None:
            return [e for e in self.Parent.Elements \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM14r05.Meas.StringMeasurement" ]
        else:
            return []
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "RemoteSource", "MeasurementValueQuality", "MeasurementValueSource", "MemberOf_Measurement",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.StringMeasurementValue",
...
class StringMeasurement(Measurement):
    ...
    Contains_MeasurementValues = List(Instance("CIM14r05.Meas.StringMeasurementValue"))
    ...
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "Unit", "MeasurementType", "MemberOf_PSR", "Terminal", "Contains_MeasurementValues",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.StringMeasurement",
...
class Command(Control):
    ...
    MeasuredBy_Measurement = Instance("CIM14r05.Meas.Discrete",
        transient=True,
        opposite="ControlledBy_Control",
        editor=InstanceEditor(name="_discretes"))
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "operationInProgress", "timeStamp", "normalValue", "value",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "ControlType", "ControlledBy_RegulatingCondEq", "RemoteControl", "Unit", "ValueAliasSet", "MeasuredBy_Measurement",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.Command",
        title="Command",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class AccumulatorLimit(Limit):
    ...
    LimitSet = Instance("CIM14r05.Meas.AccumulatorLimitSet",
        transient=True,
        opposite="Limits",
    ...
    def _get_accumulatorlimitsets(self):
        ...
        if self.Parent is not None:
            return [e for e in self.Parent.Elements \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM14r05.Meas.AccumulatorLimitSet" ]
        else:
            return []
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "LimitSet",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.AccumulatorLimit",
...
class Analog(Measurement):
    ...
    Contain_MeasurementValues = List(Instance("CIM14r05.Meas.AnalogValue"))

    # A measurement may have zero or more limit ranges defined for it.
    LimitSets = List(Instance("CIM14r05.Meas.AnalogLimitSet"),
        desc="A measurement may have zero or more limit ranges defined for it.")

    # The Control variable associated with the Measurement
    ControlledBy_Control = Instance("CIM14r05.Meas.SetPoint",
        desc="The Control variable associated with the Measurement",
        transient=True,
        opposite="MeasuredBy_Measurement",
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "positiveFlowIn", "normalValue", "maxValue", "minValue",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "Unit", "MeasurementType", "MemberOf_PSR", "Terminal", "Contain_MeasurementValues", "LimitSets", "ControlledBy_Control",
                label="References"),
            dock="tab"),
        id="CIM14r05.Meas.Analog",
        title="Analog",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
