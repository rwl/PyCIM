...
ContingencyEquipmentStatusKind = Enum("inService", "outOfService")
...
class Contingency(IdentifiedObject):
    ...
    ContingencyElement = List(Instance("CIM14r05.Contingency.ContingencyElement"))
    ...
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "mustStudy",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "ContingencyElement",
                label="References"),
            dock="tab"),
        id="CIM14r05.Contingency.Contingency",
        title="Contingency",
...
class ContingencyElement(IdentifiedObject):
    ...
    Contingency = Instance("CIM14r05.Contingency.Contingency",
        transient=True,
        ...
        if self.Parent is not None:
            return [e for e in self.Parent.Elements \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM14r05.Contingency.Contingency" ]
        else:
            return []
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "ModelingAuthoritySet", "Contingency",
                label="References"),
            dock="tab"),
        id="CIM14r05.Contingency.ContingencyElement",
...
class ContingencyEquipment(ContingencyElement):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("description", "mRID", "pathName", "localName", "aliasName", "name", "contingentStatus",
                label="Attributes"),
            VGroup("Parent", "ModelingAuthoritySet", "Contingency", "Equipment",
                label="References"),
            dock="tab"),
        id="CIM14r05.Contingency.ContingencyEquipment",
