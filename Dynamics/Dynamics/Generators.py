...
class GenSync(RotatingMachine):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Model",
                label="References"),
            dock="tab"),
        id="dynamics.Dynamics.Generators.GenSync",
        title="GenSync",
...
class GenLoad(Element):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Model",
                label="References"),
            dock="tab"),
        id="dynamics.Dynamics.Generators.GenLoad",
        title="GenLoad",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class GenAsync(AsynchronousMachine):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Model",
                label="References"),
            dock="tab"),
        id="dynamics.Dynamics.Generators.GenAsync",
        title="GenAsync",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class GenEquiv(RotatingMachine):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "ratedS", "s1", "s12", "h", "d", "rs", "xls", "xp",
                label="Attributes"),
            VGroup("Model",
                label="References"),
            dock="tab"),
        id="dynamics.Dynamics.Generators.GenEquiv",
        title="GenEquiv",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
