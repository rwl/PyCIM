...
class AggregateLoad(Element):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Model",
                label="References"),
            dock="tab"),
        id="dynamics.Dynamics.Loads.AggregateLoad",
        title="AggregateLoad",
...
class LoadStatic(AggregateLoad):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "ep2", "ep1", "kp2", "ep3", "kp1", "kq4", "kq3", "kq2", "kq1", "eq1", "eq2", "kp4", "kp3", "eq3", "kqf", "kpf",
                label="Attributes", columns=1),
            VGroup("Model",
                label="References"),
            dock="tab"),
        id="dynamics.Dynamics.Loads.LoadStatic",
        title="LoadStatic",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class LoadMotor(AggregateLoad):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "lfac", "ra", "d", "ls", "tppo", "tbkr", "lpp", "tpo", "lp", "h", "vt", "pfrac", "tv",
                label="Attributes", columns=1),
            VGroup("Model",
                label="References"),
            dock="tab"),
        id="dynamics.Dynamics.Loads.LoadMotor",
        title="LoadMotor",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class LoadStaticBus(LoadStatic):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Model",
                label="References"),
            dock="tab"),
        id="dynamics.Dynamics.Loads.LoadStaticBus",
        title="LoadStaticBus",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class LoadStaticZone(LoadStatic):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Model",
                label="References"),
            dock="tab"),
        id="dynamics.Dynamics.Loads.LoadStaticZone",
...
class LoadStaticArea(LoadStatic):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Model",
                label="References"),
            dock="tab"),
        id="dynamics.Dynamics.Loads.LoadStaticArea",
...
class LoadStaticSystem(LoadStatic):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Model",
                label="References"),
            dock="tab"),
        id="dynamics.Dynamics.Loads.LoadStaticSystem",
...
class LoadStaticOwner(LoadStatic):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Model",
                label="References"),
            dock="tab"),
        id="dynamics.Dynamics.Loads.LoadStaticOwner",
