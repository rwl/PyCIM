...
class ProtectionEquipment(Equipment):
    ...
    # @generated
    def __init__(self, unit_multiplier='m', unit_symbol='m2', high_limit=0.0, power_direction_flag=False, low_limit=0.0, relay_delay_time=0.0, protected_switches=None, conducting_equipments=None, *args, **kw_args):
        """ Initialises a new 'ProtectionEquipment' instance.

        @param unit_multiplier: The unit multiplier of the value. Values are: "m", "t", "p", "k", "m", "micro", "n", "d", "g", "c", "none"
        @param unit_symbol: The unit of measure of the value. Values are: "m2", "var", "m3", "g", "varh", "f", "hz", "deg", "w/s", "v", "v/var", "rad", "min", "ohm", "m", "h", "s", "w/hz", "kg/j", "wh", "va", "s", "none", "º_c", "s-1", "j", "n", "h", "j/s", "hz-1", "pa", "w", "a", "vah"
        ...
        """
        # The unit multiplier of the value. Values are: "m", "t", "p", "k", "m", "micro", "n", "d", "g", "c", "none"
        self.unit_multiplier = unit_multiplier

        # The unit of measure of the value. Values are: "m2", "var", "m3", "g", "varh", "f", "hz", "deg", "w/s", "v", "v/var", "rad", "min", "ohm", "m", "h", "s", "w/hz", "kg/j", "wh", "va", "s", "none", "º_c", "s-1", "j", "n", "h", "j/s", "hz-1", "pa", "w", "a", "vah"
