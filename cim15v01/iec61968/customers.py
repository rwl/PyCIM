...
class ServiceCategory(IdentifiedObject):
    ...
    def __init__(self, kind='refuse', customer_agreements=None, service_delivery_points=None, spaccounting_functions=None, pricing_structures=None, *args, **kw_args):
        ...
        @param kind: Kind of service. Values are: "refuse", "other", "tv_licence", "internet", "electricity", "water", "heat", "rates", "gas", "sewerage", "time"
        ...
        """
        # Kind of service. Values are: "refuse", "other", "tv_licence", "internet", "electricity", "water", "heat", "rates", "gas", "sewerage", "time"
        self.kind = kind
...
class ServiceLocation(GeoLocation):
    ...
    # <<< service_location
    # @generated
    def __init__(self, needs_inspection=False, access_method='', site_access_problem='', customer_agreements=None, end_device_assets=None, service_delivery_points=None, erp_persons=None, *args, **kw_args):
