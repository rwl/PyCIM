...
from cim15v01.iec61970.wires import ACLineSegment
from cim15v01.iec61970.wires import RatioTapChanger
...
class DistributionTapChanger(RatioTapChanger):
    ...
    def __init__(self, monitored_phase='bc', target_voltage=0.0, reverse_line_drop_r=0.0, limit_voltage=0.0, reverse_line_drop_x=0.0, line_drop_r=0.0, line_drop_compensation=False, line_drop_x=0.0, band_voltage=0.0, ct_rating=0.0, pt_ratio=0.0, ct_ratio=0.0, *args, **kw_args):
        ...
        @param monitored_phase: Phase voltage controlling this regulator, measured at regulator location. Values are: "bc", "ab", "b", "ac", "s2_n", "abc", "abn", "abcn", "cn", "an", "bcn", "acn", "a", "c", "n", "s12_n", "bn", "s1_n"
        ...
        """
        # Phase voltage controlling this regulator, measured at regulator location. Values are: "bc", "ab", "b", "ac", "s2_n", "abc", "abn", "abcn", "cn", "an", "bcn", "acn", "a", "c", "n", "s12_n", "bn", "s1_n"
