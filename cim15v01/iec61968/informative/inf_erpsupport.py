...
from cim15v01.iec61968.informative.inf_common import BankAccount
...
class ErpOrganisation(Organisation):
    ...
    # <<< erp_organisation
    # @generated
    def __init__(self, code='', category='', mode='', opt_out=False, industry_id='', is_profit_center=False, is_cost_center=False, government_id='', document_roles=None, activity_records=None, erp_person_roles=None, violation_limits=None, requests=None, locations=None, change_items=None, int_sched_agreement=None, registered_resources=None, power_system_resource_roles=None, asset_roles=None, land_property_roles=None, parent_organisation_roles=None, child_organisation_roles=None, crews=None, *args, **kw_args):
    ...
    def set_locations(self, value):
        for p in self._locations:
            filtered = [q for q in p.erp_organisations if q != self]
            self._locations._erp_organisations = filtered
        for r in value:
            if self not in r._erp_organisations:
                r._erp_organisations.append(self)
    ...
    def add_locations(self, *locations):
        for obj in locations:
            if self not in obj._erp_organisations:
                obj._erp_organisations.append(self)
            self._locations.append(obj)

    def remove_locations(self, *locations):
        for obj in locations:
            if self in obj._erp_organisations:
                obj._erp_organisations.remove(self)
...
class ErpPerson(IdentifiedObject):
    ...
    # <<< erp_person
    # @generated
    def __init__(self, prefix='', government_id='', last_name='', category='', first_name='', suffix='', special_need='', m_name='', document_roles=None, crews=None, appointments=None, labor_items=None, measurement_values=None, call_backs=None, activity_records=None, erp_organisation_roles=None, crafts=None, skills=None, electronic_address=None, customer_data=None, change_items=None, switching_step_roles=None, erp_personnel=None, erp_competency=None, land_property_roles=None, service_location=None, landline_phone=None, mobile_phone=None, status=None, *args, **kw_args):
        ...
        @param landline_phone: Landline phone number.
    ...
    def set_service_location(self, value):
        if self._service_location is not None:
            filtered = [x for x in self.service_location.erp_persons if x != self]
            self._service_location._erp_persons = filtered

        self._service_location = value
        if self._service_location is not None:
            self._service_location._erp_persons.append(self)
