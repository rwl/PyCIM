...
from cim15v01.iec61968.common import PositionPoint
from cim15v01.iec61970.core import IdentifiedObject
from cim15v01.iec61968.informative.inf_locations import SchematicLocation
...
class GmlSelector(IdentifiedObject):
    ...
    # <<< gml_selector
    # @generated
    def __init__(self, gml_diagram_objects=None, change_items=None, *args, **kw_args):
    ...
    def set_gml_diagram_objects(self, value):
        for p in self._gml_diagram_objects:
            ...
            self._gml_diagram_objects._gml_selectors = filtered
        for r in value:
...
class GmlDiagramObject(SchematicLocation):
    """ Any of the magnitudes that serve to define the position of a point by reference to a fixed figure, system of lines, etc.
    """
    # <<< gml_diagram_object
    # @generated
    def __init__(self, gml_selectors=None, diagrams=None, gml_line_symbols=None, gml_coordinate_systems=None, gml_raster_symbols=None, gml_polygon_symbols=None, gml_point_symbols=None, gml_text_symbols=None, gml_observatins=None, *args, **kw_args):
    ...
    def set_gml_selectors(self, value):
        for p in self._gml_selectors:
            ...
            self._gml_selectors._gml_diagram_objects = filtered
        for r in value:
    ...
    def set_gml_observatins(self, value):
        for p in self._gml_observatins:
            filtered = [q for q in p.gml_diagram_objects if q != self]
            self._gml_observatins._gml_diagram_objects = filtered
        for r in value:
            if self not in r._gml_diagram_objects:
                r._gml_diagram_objects.append(self)
...
class GmlObservation(Element):
    ...
    # <<< gml_observation
    # @generated
    def __init__(self, target='', using='', date_time='', result_of='', change_items=None, gml_values=None, gml_diagram_objects=None, *args, **kw_args):
    ...
    def set_gml_diagram_objects(self, value):
        for p in self._gml_diagram_objects:
            ...
            self._gml_diagram_objects._gml_observatins = filtered
        for r in value:
