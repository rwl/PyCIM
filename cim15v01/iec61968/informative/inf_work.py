...
from cim15v01.iec61968.informative.inf_common import ScheduledEvent
from cim15v01.iec61968.informative.inf_assets import ProcedureDataSet
...
class DiagnosisDataSet(ProcedureDataSet):
    ...
    def __init__(self, phase_code='bc', failure_mode='', root_remark='', root_cause='', final_origin='', final_cause='', preliminary_code='', effect='', preliminary_remark='', root_origin='', final_code='', final_remark='', preliminary_date_time='', *args, **kw_args):
        ...
        @param phase_code: Phase(s) diagnosed. Values are: "bc", "ab", "b", "ac", "s2_n", "abc", "abn", "abcn", "cn", "an", "bcn", "acn", "a", "c", "n", "s12_n", "bn", "s1_n"
        ...
        """
        # Phase(s) diagnosed. Values are: "bc", "ab", "b", "ac", "s2_n", "abc", "abn", "abcn", "cn", "an", "bcn", "acn", "a", "c", "n", "s12_n", "bn", "s1_n"
...
class WorkLocation(GeoLocation):
