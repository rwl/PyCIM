...
class NonConformLoad(EnergyConsumer):
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name", "qfixedPct", "pfixed", "qfixed", "pfixedPct",
                label="Attributes"),
            VGroup("Parent", "Contains_Measurements", "MemberOf_EquipmentContainer", "OperationalLimitSet", "BaseVoltage", "Terminals", "LoadResponse", "LoadGroup",
                label="References"),
            dock="tab"),
...
class SeasonDayTypeSchedule(RegularIntervalSchedule):
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name", "startTime", "value1Unit", "value2Unit", "endTime", "timeStep",
                label="Attributes"),
            VGroup("Parent", "TimePoints", "DayType", "Season",
                label="References"),
            dock="tab"),
...
class NonConformLoadGroup(LoadGroup):
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "SubLoadArea", "NonConformLoadSchedules", "EnergyConsumers",
                label="References"),
            dock="tab"),
...
class ConformLoadSchedule(SeasonDayTypeSchedule):
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name", "startTime", "value1Unit", "value2Unit", "endTime", "timeStep",
                label="Attributes"),
            VGroup("Parent", "TimePoints", "DayType", "Season", "ConformLoadGroup",
                label="References"),
            dock="tab"),
...
class ConformLoadGroup(LoadGroup):
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "SubLoadArea", "EnergyConsumers", "ConformLoadSchedules",
                label="References"),
            dock="tab"),
...
class LoadArea(EnergyArea):
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "ControlArea", "SubLoadAreas",
                label="References"),
            dock="tab"),
...
class SubLoadArea(EnergyArea):
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "ControlArea", "LoadGroups", "LoadArea",
                label="References"),
            dock="tab"),
...
class NonConformLoadSchedule(SeasonDayTypeSchedule):
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name", "startTime", "value1Unit", "value2Unit", "endTime", "timeStep",
                label="Attributes"),
            VGroup("Parent", "TimePoints", "DayType", "Season", "NonConformLoadGroup",
                label="References"),
            dock="tab"),
