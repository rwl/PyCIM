...
class GrossToNetActivePowerCurve(Curve):
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name", "y2Unit", "xUnit", "curveStyle", "y1Unit",
                label="Attributes"),
            VGroup("Parent", "CurveScheduleDatas", "GeneratingUnit",
                label="References"),
            dock="tab"),
...
class GeneratingUnit(Equipment):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "Contains_Measurements", "MemberOf_EquipmentContainer", "OperationalLimitSet", "Contains_SynchronousMachines", "GrossToNetActivePowerCurves", "ControlAreaGeneratingUnit",
                label="References"),
            dock="tab"),
