...
class RegularTimePoint(Element):
    ...
    IntervalSchedule = Instance("CPSM.Core.RegularIntervalSchedule", allow_none=False,
        ...
        if self.Parent is not None:
            return [e for e in self.Parent.Elements \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CPSM.Core.RegularIntervalSchedule" ]
        else:
            return []
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "value1", "sequenceNumber", "value2",
                label="Attributes"),
            VGroup("Parent", "IntervalSchedule",
                label="References"),
            dock="tab"),
        id="CPSM.Core.RegularTimePoint",
...
class CurveData(Element):
    ...
    CurveSchedule = Instance("CPSM.Core.Curve", allow_none=False,
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "y2value", "xvalue", "y1value",
                label="Attributes"),
            VGroup("Parent", "CurveSchedule",
                label="References"),
            dock="tab"),
        id="CPSM.Core.CurveData",
        title="CurveData",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class Terminal(IdentifiedObject):
    ...
    Measurements = List(Instance("CPSM.Meas.Measurement"),
    ...
    ConnectivityNode = Instance("CPSM.Topology.ConnectivityNode",
    ...
    def _get_connectivitynodes(self):
        ...
        if self.Parent is not None:
            return [e for e in self.Parent.Elements \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CPSM.Topology.ConnectivityNode" ]
        else:
            return []
    ...
    ConductingEquipment = Instance("CPSM.Core.ConductingEquipment", allow_none=False,
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "Measurements", "RegulatingControl", "ConnectivityNode", "ConductingEquipment",
                label="References"),
            dock="tab"),
        id="CPSM.Core.Terminal",
        title="Terminal",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class BaseVoltage(IdentifiedObject):
    ...
    ConductingEquipment = List(Instance("CPSM.Core.ConductingEquipment"),
    ...
    VoltageLevel = List(Instance("CPSM.Core.VoltageLevel"),
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name", "nominalVoltage",
                label="Attributes"),
            VGroup("Parent", "ConductingEquipment", "VoltageLevel",
                label="References"),
            dock="tab"),
        id="CPSM.Core.BaseVoltage",
        title="BaseVoltage",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class SubGeographicalRegion(IdentifiedObject):
    ...
    Region = Instance("CPSM.Core.GeographicalRegion", allow_none=False,
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "Region", "Lines", "Substations",
                label="References"),
            dock="tab"),
        id="CPSM.Core.SubGeographicalRegion",
...
class Curve(IdentifiedObject):
    ...
    CurveScheduleDatas = List(Instance("CPSM.Core.CurveData"),
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name", "y2Unit", "xUnit", "curveStyle", "y1Unit",
                label="Attributes"),
            VGroup("Parent", "CurveScheduleDatas",
                label="References"),
            dock="tab"),
        id="CPSM.Core.Curve",
        title="Curve",
...
class PowerSystemResource(IdentifiedObject):
    ...
    Contains_Measurements = List(Instance("CPSM.Meas.Measurement"),
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "Contains_Measurements",
                label="References"),
            dock="tab"),
        id="CPSM.Core.PowerSystemResource",
...
class BasicIntervalSchedule(IdentifiedObject):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name", "startTime", "value1Unit", "value2Unit",
                label="Attributes"),
            VGroup("Parent",
                label="References"),
            dock="tab"),
        id="CPSM.Core.BasicIntervalSchedule",
...
class GeographicalRegion(IdentifiedObject):
    ...
    # The association is used in the naming hierarchy.The association is used in the naming hierarchy.
    Regions = List(Instance("CPSM.Core.SubGeographicalRegion"),
        desc="The association is used in the naming hierarchy.The association is used in the naming hierarchy.")
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "Regions",
                label="References"),
            dock="tab"),
        id="CPSM.Core.GeographicalRegion",
...
class RegularIntervalSchedule(BasicIntervalSchedule):
    ...
    # The point data values that define a curveThe point data values that define a curve
    TimePoints = List(Instance("CPSM.Core.RegularTimePoint"),
        desc="The point data values that define a curveThe point data values that define a curve")
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name", "startTime", "value1Unit", "value2Unit", "endTime", "timeStep",
                label="Attributes"),
            VGroup("Parent", "TimePoints",
                label="References"),
            dock="tab"),
        id="CPSM.Core.RegularIntervalSchedule",
...
class ConnectivityNodeContainer(PowerSystemResource):
    ...
    ConnectivityNodes = List(Instance("CPSM.Topology.ConnectivityNode"),
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "Contains_Measurements", "ConnectivityNodes",
                label="References"),
            dock="tab"),
        id="CPSM.Core.ConnectivityNodeContainer",
...
class EquipmentContainer(ConnectivityNodeContainer):
    ...
    # The association is used in the naming hierarchy.The association is used in the naming hierarchy.
    Contains_Equipments = List(Instance("CPSM.Core.Equipment"),
        desc="The association is used in the naming hierarchy.The association is used in the naming hierarchy.")
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "Contains_Measurements", "ConnectivityNodes", "Contains_Equipments",
                label="References"),
            dock="tab"),
        id="CPSM.Core.EquipmentContainer",
...
class VoltageLevel(EquipmentContainer):
    ...
    # The association is used in the naming hierarchy.The association is used in the naming hierarchy.
    MemberOf_Substation = Instance("CPSM.Core.Substation", allow_none=False,
        desc="The association is used in the naming hierarchy.The association is used in the naming hierarchy.",
        transient=True,
    ...
    BaseVoltage = Instance("CPSM.Core.BaseVoltage", allow_none=False,
    ...
    # The association is used in the naming hierarchy.The association is used in the naming hierarchy.
    Contains_Bays = List(Instance("CPSM.Core.Bay"),
        desc="The association is used in the naming hierarchy.The association is used in the naming hierarchy.")
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name", "lowVoltageLimit", "highVoltageLimit",
                label="Attributes"),
            VGroup("Parent", "Contains_Measurements", "ConnectivityNodes", "Contains_Equipments", "MemberOf_Substation", "BaseVoltage", "Contains_Bays",
                label="References"),
            dock="tab"),
        id="CPSM.Core.VoltageLevel",
        title="VoltageLevel",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class Bay(EquipmentContainer):
    ...
    # The association is used in the naming hierarchy.The association is used in the naming hierarchy.
    MemberOf_VoltageLevel = Instance("CPSM.Core.VoltageLevel", allow_none=False,
        desc="The association is used in the naming hierarchy.The association is used in the naming hierarchy.",
        transient=True,
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "Contains_Measurements", "ConnectivityNodes", "Contains_Equipments", "MemberOf_VoltageLevel",
                label="References"),
            dock="tab"),
        id="CPSM.Core.Bay",
        title="Bay",
...
class Equipment(PowerSystemResource):
    ...
    # The association is used in the naming hierarchy.The association is used in the naming hierarchy.
    MemberOf_EquipmentContainer = Instance("CPSM.Core.EquipmentContainer", allow_none=False,
        desc="The association is used in the naming hierarchy.The association is used in the naming hierarchy.",
        transient=True,
    ...
    OperationalLimitSet = List(Instance("CPSM.OperationalLimits.OperationalLimitSet"),
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "Contains_Measurements", "MemberOf_EquipmentContainer", "OperationalLimitSet",
                label="References"),
            dock="tab"),
        id="CPSM.Core.Equipment",
        title="Equipment",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class Substation(EquipmentContainer):
    ...
    # The association is used in the naming hierarchy.The association is used in the naming hierarchy.
    Contains_VoltageLevels = List(Instance("CPSM.Core.VoltageLevel"),
        desc="The association is used in the naming hierarchy.The association is used in the naming hierarchy.")
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "pathName", "description", "aliasName", "name",
                label="Attributes"),
            VGroup("Parent", "Contains_Measurements", "ConnectivityNodes", "Contains_Equipments", "Region", "Contains_VoltageLevels",
                label="References"),
            dock="tab"),
        id="CPSM.Core.Substation",
        title="Substation",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class ConductingEquipment(Equipment):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("Parent", "Contains_Measurements", "MemberOf_EquipmentContainer", "OperationalLimitSet", "BaseVoltage", "Terminals",
                label="References"),
            dock="tab"),
        id="CPSM.Core.ConductingEquipment",
