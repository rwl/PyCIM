...
""" Defines a graph editor for CIM14r05.
"""
...
from CIM14r05 import *
from CIM14r05.LoadModel import *
from CIM14r05.Generation import *
from CIM14r05.Wires import *
from CIM14r05.Core import *
from CIM14r05.StateVariables import *
from CIM14r05.Meas import *
from CIM14r05.SCADA import *
from CIM14r05.Topology import *
from CIM14r05.Contingency import *
from CIM14r05.ControlArea import *
from CIM14r05.Domain import *
from CIM14r05.Equivalents import *
from CIM14r05.Protection import *
from CIM14r05.Outage import *
from CIM14r05.OperationalLimits import *
from CIM14r05.Generation.Production import *
from CIM14r05.Generation.GenerationDynamics import *
...
WindGeneratingUnit_GraphNode = GraphNode(
...
RatioTapChanger_GraphNode = GraphNode(
...
PhaseTapChanger_GraphNode = GraphNode(
...
SvPowerFlow_GraphNode = GraphNode(
    node_for=[SvPowerFlow],
        tooltip="State variable for power flow.",
    on_dclick=lambda obj: obj.edit_traits(kind="livemodal"))

SvTapStep_GraphNode = GraphNode(
    node_for=[SvTapStep],
        tooltip="State variable for transformer tap step.     Normally a profile specifies only one of the attributes 'position'or 'continuousPosition'.",
    on_dclick=lambda obj: obj.edit_traits(kind="livemodal"))

SvShuntCompensatorSections_GraphNode = GraphNode(
    node_for=[SvShuntCompensatorSections],
        tooltip="State variable for the number of sections in service for a shunt compensator.",
    on_dclick=lambda obj: obj.edit_traits(kind="livemodal"))

StateVariable_GraphNode = GraphNode(
    node_for=[StateVariable],
        tooltip="An abstract class for state variables.",
    on_dclick=lambda obj: obj.edit_traits(kind="livemodal"))

SvStatus_GraphNode = GraphNode(
    node_for=[SvStatus],
        tooltip="State variable for status.",
    on_dclick=lambda obj: obj.edit_traits(kind="livemodal"))

SvInjection_GraphNode = GraphNode(
    node_for=[SvInjection],
        tooltip="Injectixon state variable.",
    on_dclick=lambda obj: obj.edit_traits(kind="livemodal"))

SvVoltage_GraphNode = GraphNode(
    node_for=[SvVoltage],
...
#ACLineSegment_delete_this_HasSecond_MutualCoupling_GraphEdge = GraphEdge(
#    edge_for=[ACLineSegment],
#    head_nodes=[],
#    tail_nodes=[],
#    head_label="=delete_this_HasSecond_MutualCoupling",
#    tooltip="")

#ACLineSegment_delete_this_HasFirst_MutualCoupling_GraphEdge = GraphEdge(
#    edge_for=[ACLineSegment],
#    head_nodes=[],
#    tail_nodes=[],
#    head_label="=delete_this_HasFirst_MutualCoupling",
#    tooltip="")
...
#BaseVoltage_TopologicalNode_GraphEdge = GraphEdge(
#    edge_for=[BaseVoltage],
#    head_nodes=[],
#    tail_nodes=[],
...
#Terminal_HasSecond_MutualCoupling_GraphEdge = GraphEdge(
#    edge_for=[Terminal],
#    head_nodes=[],
#    tail_nodes=[],
...
#Terminal_HasFirst_MutualCoupling_GraphEdge = GraphEdge(
#    edge_for=[Terminal],
#    head_nodes=[],
#    tail_nodes=[],
...
graph_nodes = [
    ...
    StateVariable_GraphNode,
    SvStatus_GraphNode,
    SvInjection_GraphNode,
    SvVoltage_GraphNode,
    LimitSet_GraphNode,
    ...
    SvPowerFlow_GraphNode,
    SvTapStep_GraphNode,
    SvShuntCompensatorSections_GraphNode,
    ...
    RatioTapChanger_GraphNode,
    VoltageControlZone_GraphNode,
    PhaseTapChanger_GraphNode,
...
#    BaseVoltage_TopologicalNode_GraphEdge,
...
#    Terminal_HasSecond_MutualCoupling_GraphEdge,
#    Terminal_RegulatingControl_GraphEdge,
#    Terminal_HasFirst_MutualCoupling_GraphEdge,
...
#    ACLineSegment_delete_this_HasSecond_MutualCoupling_GraphEdge,
#    ACLineSegment_delete_this_HasFirst_MutualCoupling_GraphEdge,
...
#------------------------------------------------------------------------------
#  CIM14r05 Graph Editor:
#------------------------------------------------------------------------------

CIM14r05GraphEditor = GraphEditor(nodes=graph_nodes)
