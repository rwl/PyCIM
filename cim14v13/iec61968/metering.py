...
from cim14v13.iec61968.assets import AssetFunction
from cim14v13.iec61970.meas import MeasurementValue
...
from cim14v13.iec61968.work import Work
...
class ReadingType(IdentifiedObject):
    ...
    def __init__(self, kind='power', unit='m2', multiplier='m', channel_number=0, default_quality='', dynamic_configuration='', interval_length=0.0, reverse_chronology=False, default_value_data_type='', pending=None, readings=None, interval_blocks=None, register=None, *args, **kw_args):
        ...
        @param kind: Kind of reading. Values are: "power", "voltage_angle", "other", "energy", "phase_angle", "date", "time", "volume", "voltage", "demand", "power_factor", "current_angle", "pressure", "current"
...
class ServiceDeliveryPoint(IdentifiedObject):
    ...
    def __init__(self, phase_config='other', billing_cycle='', load_mgmt='', rated_power=0.0, nominal_service_voltage=0, rated_current=0.0, estimated_load=0.0, check_billing=False, service_delivery_remark='', service_priority='', budget_bill='', grounded=False, consumption_real_energy=0.0, ctpt_reference=0, service_supplier=None, sdplocations=None, customer_agreement=None, meter_readings=None, energy_consumer=None, pricing_structures=None, service_category=None, power_quality_pricings=None, service_location=None, end_device_assets=None, *args, **kw_args):
        ...
        @param phase_config: Phase configuration kind. Values are: "other", "two_phase_two_wire", "three_phase_two_wire", "three_phase_four_wire", "two_phase_three_wire", "three_phase_three_wire", "one_phase_three_wire", "one_phase_two_wire"
