...
from cim14v13.iec61970.core import EquipmentContainer
...
class ChangeItem(IdentifiedObject):
    ...
    # <<< change_item
    # @generated
    def __init__(self, kind='add', sequence_number=0, power_system_resource=None, location=None, organisation=None, status=None, asset=None, document=None, gml_observation=None, erp_person=None, measurement=None, gml_selector=None, change_set=None, network_data_set=None, *args, **kw_args):
