...
class MountingPoint(IdentifiedObject):
    ...
    def __init__(self, phase_code='bc', y_coord=0, x_coord=0, overhead_conductors=None, connections=None, *args, **kw_args):
        ...
        @param phase_code: Values are: "bc", "ab", "b", "ac", "abc", "split_secondary1_n", "abn", "abcn", "cn", "an", "split_secondary12_n", "bcn", "split_secondary2_n", "acn", "a", "c", "n", "bn"
        @param y_coord:
        @param x_coord:
        @param overhead_conductors:
        @param connections:
        """
        # Values are: "bc", "ab", "b", "ac", "abc", "split_secondary1_n", "abn", "abcn", "cn", "an", "split_secondary12_n", "bcn", "split_secondary2_n", "acn", "a", "c", "n", "bn"
