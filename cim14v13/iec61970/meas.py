...
class Measurement(IdentifiedObject):
    ...
    # <<< measurement
    # @generated
    def __init__(self, measurement_type='', asset=None, for_tie_point=None, power_system_resource=None, dynamic_schedules=None, pnode=None, terminal=None, documents=None, locations=None, change_items=None, violation_limits=None, by_tie_point=None, unit=None, *args, **kw_args):
...
class Control(IdentifiedObject):
    ...
    # <<< control
    # @generated
    def __init__(self, time_stamp='', operation_in_progress=False, remote_control=None, unit=None, regulating_cond_eq=None, control_type=None, *args, **kw_args):
