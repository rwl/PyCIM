...
class PowerSystemResource(IdentifiedObject):
    ...
    # <<< power_system_resource
    # @generated
    def __init__(self, change_items=None, asset_roles=None, geo_location=None, safety_documents=None, outage_schedule=None, measurements=None, erp_organisation_roles=None, psrtype=None, psr_lists=None, psrevent=None, operating_share=None, schedule_steps=None, document_roles=None, reporting_group=None, circuit_sections=None, network_data_sets=None, *args, **kw_args):
...
class Equipment(PowerSystemResource):
    ...
    # <<< equipment
    # @generated
    def __init__(self, norma_ily_in_service=False, contingency_equipment=None, customer_agreements=None, operational_limit_set=None, equipment_container=None, *args, **kw_args):
...
class ConductingEquipment(Equipment):
    ...
    def __init__(self, phases='bc', terminals=None, clearance_tags=None, outage_step_roles=None, base_voltage=None, electrical_assets=None, sv_status=None, protection_equipments=None, *args, **kw_args):
        ...
        @param phases: Describes the phases carried by a conducting equipment. Values are: "bc", "ab", "b", "ac", "abc", "split_secondary1_n", "abn", "abcn", "cn", "an", "split_secondary12_n", "bcn", "split_secondary2_n", "acn", "a", "c", "n", "bn"
        ...
        """
        # Describes the phases carried by a conducting equipment. Values are: "bc", "ab", "b", "ac", "abc", "split_secondary1_n", "abn", "abcn", "cn", "an", "split_secondary12_n", "bcn", "split_secondary2_n", "acn", "a", "c", "n", "bn"
        self.phases = phases
...
class Unit(IdentifiedObject):
    ...
    # <<< unit
    # @generated
    def __init__(self, controls=None, protection_equipments=None, measurements=None, *args, **kw_args):
        """ Initialises a new 'Unit' instance.

        @param controls: The Controls having the Unit.
        @param protection_equipments: The Protection Equipments having the Unit.
