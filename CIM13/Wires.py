...
class RegulationSchedule(RegularIntervalSchedule):
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "value2Unit", "startTime", "value2Multiplier", "value1Unit", "value1Multiplier", "timeStep", "endTime", "lineDropR", "lineDropCompensation", "lineDropX",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "TimePoints", "RegulatingControl", "VoltageControlZones",
                label="References"),
            dock="tab"),
        id="CIM13.Wires.RegulationSchedule",
...
class TransformerWinding(ConductingEquipment):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases", "ratedU", "rground", "b0", "r", "xground", "b", "r0", "grounded", "shortTermS", "ratedS", "x", "windingType", "emergencyS", "insulationU", "g", "g0", "x0", "connectionType",
            ...
            dock="tab"),
        id="CIM13.Wires.TransformerWinding",
...
class EnergySource(ConductingEquipment):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases", "r0", "nominalVoltage", "r", "voltageMagnitude", "x", "voltageAngle", "rn", "activePower", "xn", "x0",
                label="Attributes", columns=1),
...
class SeriesCompensator(ConductingEquipment):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.SeriesCompensator",
...
class WireType(IdentifiedObject):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "phaseConductorCount", "gMR", "phaseConductorSpacing", "ratedCurrent", "radius", "resistance",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "WireArrangements",
                label="References"),
            dock="tab"),
        id="CIM13.Wires.WireType",
        title="WireType",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class VoltageControlZone(PowerSystemResource):
    ...
    def _get_regulationschedules(self):
        ...
        if self.ContainedBy is not None:
            return [e for e in self.ContainedBy.Contains \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM13.Wires.RegulationSchedule" ]
        else:
            return []
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName",
                label="Attributes"),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "RegulationSchedule", "BusbarSection",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.VoltageControlZone",
...
class RegulatingCondEq(ConductingEquipment):
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases",
                label="Attributes"),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags", "RegulatingControl", "Controls",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.RegulatingCondEq",
...
class Conductor(ConductingEquipment):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases", "r0", "g0ch", "length", "x", "gch", "b0ch", "bch", "x0", "r",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags", "ConductorType",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.Conductor",
        title="Conductor",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class Line(EquipmentContainer):
    ...
    def _get_subgeographicalregions(self):
        ...
        if self.ContainedBy is not None:
            return [e for e in self.ContainedBy.Contains \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM13.Core.SubGeographicalRegion" ]
        else:
            return []
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName",
                label="Attributes"),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "TopologicalNode", "ConnectivityNodes", "Contains_Equipments", "Region",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.Line",
        title="Line",
...
class TapChanger(PowerSystemResource):
    ...
    def _get_transformerwindings(self):
        ...
        if self.ContainedBy is not None:
            return [e for e in self.ContainedBy.Contains \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM13.Wires.TransformerWinding" ]
        else:
            return []
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "neutralStep", "lowStep", "tculControlMode", "neutralU", "normalStep", "highStep", "type", "stepVoltageIncrement", "subsequentDelay", "initialDelay", "stepPhaseShiftIncrement",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "TransformerWinding", "RegulatingControl",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.TapChanger",
        title="TapChanger",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class CompositeSwitch(Equipment):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "compositeSwitchType",
                label="Attributes"),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Switches",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.CompositeSwitch",
...
class WireArrangement(IdentifiedObject):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "mountingPointX", "mountingPointY",
                label="Attributes"),
            VGroup("ContainedBy", "ModelingAuthoritySet", "ConductorType", "WireType",
                label="References"),
            dock="tab"),
        id="CIM13.Wires.WireArrangement",
...
class PowerTransformer(Equipment):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "transfCoolingType", "phases", "bmagSat", "magSatFlux", "magBaseU",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Contains_TransformerWindings", "HeatExchanger",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.PowerTransformer",
...
class MutualCoupling(Root):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "x0", "distance22", "distance11", "distance12", "r0", "b0ch", "g0ch", "distance21",
                label="Attributes"),
            VGroup("ContainedBy", "First_ACLineSegment", "Second_ACLineSegment",
                label="References"),
            dock="tab"),
        id="CIM13.Wires.MutualCoupling",
...
class RectifierInverter(ConductingEquipment):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases", "ratedU", "operatingMode", "frequency", "maxU", "commutatingResistance", "minP", "bridges", "commutatingReactance", "maxP", "minCompoundVoltage", "compoundResistance", "minU",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.RectifierInverter",
...
class HeatExchanger(Equipment):
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService",
                label="Attributes"),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "PowerTransformer",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.HeatExchanger",
        title="HeatExchanger",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class EnergyConsumer(ConductingEquipment):
    ...
    def _get_loadresponsecharacteristics(self):
        ...
        if self.ContainedBy is not None:
            return [e for e in self.ContainedBy.Contains \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM13.LoadModel.LoadResponseCharacteristic" ]
        else:
            return []
...
class Switch(ConductingEquipment):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases", "retained", "switchOnDate", "normalOpen", "switchOnCount",
                label="Attributes", columns=1),
...
class WindingTest(IdentifiedObject):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "loadLoss", "toTapStep", "fromTapStep", "noLoadLoss", "voltage", "phaseShift", "leakageImpedance", "excitingCurrent",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "To_TransformerWinding", "From_TransformerWinding",
                label="References"),
            dock="tab"),
        id="CIM13.Wires.WindingTest",
        title="WindingTest",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class ConductorType(IdentifiedObject):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "sheathReactance", "sheathResistance",
                label="Attributes"),
            VGroup("ContainedBy", "ModelingAuthoritySet", "Conductors", "WireArrangements",
                label="References"),
            dock="tab"),
        id="CIM13.Wires.ConductorType",
        title="ConductorType",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class ReactiveCapabilityCurve(Curve):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "y1Unit", "curveStyle", "y2Multiplier", "y2Unit", "y1Multiplier", "xMultiplier", "xUnit", "coolantTemperature", "hydrogenPressure",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "CurveScheduleDatas", "SynchronousMachines", "InitiallyUsedBySynchronousMachine",
                label="References"),
            dock="tab"),
        id="CIM13.Wires.ReactiveCapabilityCurve",
...
class GroundDisconnector(Switch):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags", "SwitchingOperations", "CompositeSwitch",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.GroundDisconnector",
...
class FrequencyConverter(RegulatingCondEq):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases", "maxP", "frequency", "minU", "minP", "operatingMode", "maxU",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags", "RegulatingControl", "Controls",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.FrequencyConverter",
...
class ProtectedSwitch(Switch):
    ...
    traits_view = View(Tabbed(
            ...
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags", "SwitchingOperations", "CompositeSwitch", "OperatedBy_ProtectionEquipments", "RecloseSequences",
                label="References", columns=2),
            dock="tab"),
        id="CIM13.Wires.ProtectedSwitch",
...
class DCLineSegment(Conductor):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases", "r0", "g0ch", "length", "x", "gch", "b0ch", "bch", "x0", "r", "dcSegmentInductance", "dcSegmentResistance",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags", "ConductorType",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.DCLineSegment",
        title="DCLineSegment",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class BusbarSection(Connector):
    ...
    def _get_voltagecontrolzones(self):
        ...
        if self.ContainedBy is not None:
            return [e for e in self.ContainedBy.Contains \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM13.Wires.VoltageControlZone" ]
        else:
            return []
    ...
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases",
                label="Attributes"),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags", "VoltageControlZone",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.BusbarSection",
        title="BusbarSection",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class ShuntCompensator(RegulatingCondEq):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases", "switchOnDate", "maxU", "aVRDelay", "maximumSections", "yPerSection", "voltageSensitivity", "switchOnCount", "normalSections", "nomQ", "reactivePerSection", "g0PerSection", "nomU", "minU", "b0PerSection",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags", "RegulatingControl", "Controls",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.ShuntCompensator",
...
class Fuse(Switch):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases", "retained", "switchOnDate", "normalOpen", "switchOnCount", "ampRating",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags", "SwitchingOperations", "CompositeSwitch",
                label="References", columns=1),
            dock="tab"),
...
class SynchronousMachine(RegulatingCondEq):
    ...
    def _get_hydropumps(self):
        ...
        if self.ContainedBy is not None:
            return [e for e in self.ContainedBy.Contains \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM13.Generation.Production.HydroPump" ]
        else:
            return []
    ...
    def _get_generatingunits(self):
        ...
        if self.ContainedBy is not None:
            return [e for e in self.ContainedBy.Contains \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM13.Generation.Production.GeneratingUnit" ]
        else:
            return []
    ...
    def _get_reactivecapabilitycurves(self):
        ...
        if self.ContainedBy is not None:
            return [e for e in self.ContainedBy.Contains \
                if "%s.%s" % (e.__module__, e.__class__.__name__) == \
                    "CIM13.Wires.ReactiveCapabilityCurve" ]
        else:
            return []
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases", "maxQ", "coolantType", "xQuadSubtrans", "xQuadSync", "operatingMode", "minQ", "x0", "manualToAVR", "maxU", "r2", "xDirectTrans", "damping", "aVRToManualLag", "x", "minU", "inertia", "aVRToManualLead", "r", "ratedS", "condenserP", "baseQ", "xQuadTrans", "r0", "referencePriority", "qPercent", "xDirectSync", "x2", "coolantCondition", "type", "xDirectSubtrans",
            ...
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags", "RegulatingControl", "Controls", "ReactiveCapabilityCurves", "Drives_HydroPump", "MemberOf_GeneratingUnit", "InitialReactiveCapabilityCurve", "DrivenBy_PrimeMover",
                label="References", columns=2),
            dock="tab"),
        id="CIM13.Wires.SynchronousMachine",
...
class StaticVarCompensator(RegulatingCondEq):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases", "voltageSetPoint", "capacitiveRating", "sVCControlMode", "slope", "inductiveRating",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags", "RegulatingControl", "Controls",
                label="References", columns=1),
            dock="tab"),
        id="CIM13.Wires.StaticVarCompensator",
...
class Breaker(ProtectedSwitch):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases", "retained", "switchOnDate", "normalOpen", "switchOnCount", "inTransitTime", "ratedCurrent",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags", "SwitchingOperations", "CompositeSwitch", "OperatedBy_ProtectionEquipments", "RecloseSequences",
                label="References", columns=2),
            dock="tab"),
        id="CIM13.Wires.Breaker",
        title="Breaker",
        buttons=["OK", "Cancel", "Help"],
        resizable=False)
...
class LoadBreakSwitch(ProtectedSwitch):
    ...
    # @generated
    traits_view = View(Tabbed(
            VGroup("URI", "name", "localName", "description", "aliasName", "mRID", "pathName", "normalIlyInService", "phases", "retained", "switchOnDate", "normalOpen", "switchOnCount", "ratedCurrent",
                label="Attributes", columns=1),
            VGroup("ContainedBy", "ModelingAuthoritySet", "PSRType", "OperatedBy_Companies", "ReportingGroup", "OperatingShare", "PsrLists", "OutageSchedule", "Contains_Measurements", "OperationalLimitSet", "ContingencyEquipment", "MemberOf_EquipmentContainer", "Terminals", "ProtectionEquipments", "BaseVoltage", "ClearanceTags", "SwitchingOperations", "CompositeSwitch", "OperatedBy_ProtectionEquipments", "RecloseSequences",
                label="References", columns=2),
            dock="tab"),
        id="CIM13.Wires.LoadBreakSwitch",
