...
#  Trait definitions:
#------------------------------------------------------------------------------
LongLength = Float(0, desc="http://www.w3.org/2001/XMLSchema#floatLong unit of length.Long unit of length.")
Money = Float(0, desc="http://www.w3.org/2001/XMLSchema#floatAmount of moneyAmount of money")
