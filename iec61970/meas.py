...
class Measurement(IdentifiedObject):
    ...
    MeasurementType = Instance("iec61970.meas.MeasurementType.MeasurementType", allow_none=False)
    ...
    MemberOf_PSR = Instance("iec61970.core.PowerSystemResource.PowerSystemResource", allow_none=False)
...
class MeasurementValue(IdentifiedObject):
    ...
    MeasurementValueQuality = Instance("iec61970.meas.MeasurementValueQuality.MeasurementValueQuality", allow_none=False)
    ...
    MeasurementValueSource = Instance("iec61970.meas.MeasurementValueSource.MeasurementValueSource", allow_none=False)
    # Links to the physical telemetered point associated with this measurement.
    RemoteSource = Instance("iec61970.scada.RemoteSource.RemoteSource")
...
class ValueAliasSet(IdentifiedObject):
    ...
    Values = List(Instance("iec61970.meas.ValueToAlias.ValueToAlias"))
    # The Controls using the set for translation
    Controls = List(Instance("iec61970.meas.Command.Command"))
    # The Measurements using the set for translation
    Measurements = List(Instance("iec61970.meas.Discrete.Discrete"))
...
class ValueToAlias(IdentifiedObject):
    ...
    ValueAliasSet = Instance("iec61970.meas.ValueAliasSet.ValueAliasSet", allow_none=False)
...
class Control(IdentifiedObject):
    ...
    """
    ControlledBy_RegulatingCondEq = Instance("iec61970.wires.RegulatingCondEq.RegulatingCondEq")
    Unit = Instance("iec61970.core.Unit.Unit", allow_none=False)
    # The type of Control
    ControlType = Instance("iec61970.meas.ControlType.ControlType", allow_none=False)
    RemoteControl = Instance("iec61970.scada.RemoteControl.RemoteControl")
...
class MeasurementValueSource(IdentifiedObject):
    ...
    MeasurementValues = List(Instance("iec61970.meas.MeasurementValue.MeasurementValue"))
...
class Accumulator(Measurement):
    ...
    """
    Contain_MeasurementValues = List(Instance("iec61970.meas.AccumulatorValue.AccumulatorValue"))
    LimitSets = List(Instance("iec61970.meas.AccumulatorLimitSet.AccumulatorLimitSet"))
...
class Analog(Measurement):
    ...
    LimitSets = List(Instance("iec61970.meas.AnalogLimitSet.AnalogLimitSet"))
    Contain_MeasurementValues = List(Instance("iec61970.meas.AnalogValue.AnalogValue"))
    # The Control variable associated with the Measurement
    ControlledBy_Control = Instance("iec61970.meas.SetPoint.SetPoint")
    # Normal value range maximum for any of the MeasurementValue.values. Used for scaling, e.g. in bar graphs or of telemetered raw values.
    maxValue = Float
...
class Discrete(Measurement):
    ...
    """
    Contain_MeasurementValues = List(Instance("iec61970.meas.DiscreteValue.DiscreteValue"))
    # The ValueAliasSet used for translation of a MeasurementValue.value to a name
    ValueAliasSet = Instance("iec61970.meas.ValueAliasSet.ValueAliasSet")
    ControlledBy_Control = Instance("iec61970.meas.Command.Command")
    # Normal value range maximum for any of the MeasurementValue.values. Used for scaling, e.g. in bar graphs or of telemetered raw values.
    maxValue = Integer
    # Normal value range minimum for any of the MeasurementValue.values. Used for scaling, e.g. in bar graphs or of telemetered raw values
    minValue = Integer
...
class AnalogValue(MeasurementValue):
    ...
    """
    MemberOf_Measurement = Instance("iec61970.meas.Analog.Analog", allow_none=False)
    value = Float

class DiscreteValue(MeasurementValue):
    """ DiscreteValue represents a discrete MeasurementValue.
    """
    MemberOf_Measurement = Instance("iec61970.meas.Discrete.Discrete", allow_none=False)
...
class AccumulatorValue(MeasurementValue):
    ...
    """
    MemberOf_Measurement = Instance("iec61970.meas.Accumulator.Accumulator", allow_none=False)
...
class AnalogLimit(Limit):
    ...
    """
    LimitSet = Instance("iec61970.meas.AnalogLimitSet.AnalogLimitSet", allow_none=False)
    # The value to supervise against.
    value = Float
...
class AccumulatorLimit(Limit):
    ...
    """
    LimitSet = Instance("iec61970.meas.AccumulatorLimitSet.AccumulatorLimitSet", allow_none=False)
    # The value to supervise against. The value is positive.
    value = Integer
...
class SetPoint(Control):
    ...
    MeasuredBy_Measurement = Instance("iec61970.meas.Analog.Analog")
...
class Command(Control):
    ...
    ValueAliasSet = Instance("iec61970.meas.ValueAliasSet.ValueAliasSet")
    MeasuredBy_Measurement = Instance("iec61970.meas.Discrete.Discrete")
    # The value representing the actuator output
    value = Integer
    # Normal value for Control.value e.g. used for percentage scaling
    normalValue = Integer
...
class AnalogLimitSet(LimitSet):
    ...
    """
    # A measurement may have zero or more limit ranges defined for it.
    Measurements = List(Instance("iec61970.meas.Analog.Analog"))
    ...
    Limits = List(Instance("iec61970.meas.AnalogLimit.AnalogLimit"))

class AccumulatorLimitSet(LimitSet):
    """ An AccumulatorLimitSet specifies a set of Limits that are associated with an Accumulator measurement.
    """
    Limits = List(Instance("iec61970.meas.AccumulatorLimit.AccumulatorLimit"))
    Measurements = List(Instance("iec61970.meas.Accumulator.Accumulator"))
