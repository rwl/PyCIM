...
class DeviceFunction(AssetFunction):
    ...
    def __init__(self, disabled=False, ComEquipmentAsset=None, EndDeviceAsset=None, Registers=None, EndDeviceEvents=None, **kw_args):
        ...
        @param ComEquipmentAsset: Communication equipment asset performing this device function.
        ...
        self.ComEquipmentAsset = ComEquipmentAsset
    ...
    def getComEquipmentAsset(self):
        ...
        """
        return self._ComEquipmentAsset

    def setComEquipmentAsset(self, value):
        if self._ComEquipmentAsset is not None:
            filtered = [x for x in self.ComEquipmentAsset.DeviceFunctions if x != self]
            self._ComEquipmentAsset._DeviceFunctions = filtered

        self._ComEquipmentAsset = value
        if self._ComEquipmentAsset is not None:
            self._ComEquipmentAsset._DeviceFunctions.append(self)

    ComEquipmentAsset = property(getComEquipmentAsset, setComEquipmentAsset)
