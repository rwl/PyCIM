...
class DistributionLineSegment(ACLineSegment):
    ...
    def __init__(self, ConductorInfo=None, SequenceImpedance=None, PhaseImpedance=None, ConductorAssets=None, *args, **kw_args):
