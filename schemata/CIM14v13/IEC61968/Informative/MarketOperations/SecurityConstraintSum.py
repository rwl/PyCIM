...
class SecurityConstraintSum(MarketFactors):
    ...
    def __init__(self, DefaultConstraintLimit=None, ConstraintTerms=None, RTO=None, BaseCaseConstraintLimit=None, ContingencyConstraintLimits=None, *args, **kw_args):
