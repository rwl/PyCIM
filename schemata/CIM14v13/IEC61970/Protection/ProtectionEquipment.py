...
class ProtectionEquipment(Equipment):
    ...
    def __init__(self, highLimit=0.0, powerDirectionFlag=False, lowLimit=0.0, relayDelayTime=0.0, ProtectedSwitches=None, Unit=None, ConductingEquipments=None, **kw_args):
