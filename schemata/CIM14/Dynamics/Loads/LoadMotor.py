...
class LoadMotor(AggregateLoad):
    ...
    def __init__(self, tv=0.0, pfrac=0.0, vt=0.0, d=0.0, ra=0.0, ls=0.0, lfac=0.0, tpo=0.0, h=0.0, lp=0.0, lpp=0.0, tppo=0.0, tbkr=0.0, **kw_args):
        """Initializes a new 'LoadMotor' instance.
