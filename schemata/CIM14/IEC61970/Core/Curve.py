...
class Curve(IdentifiedObject):
    ...
    def __init__(self, y2Multiplier='k', y3Multiplier='k', y1Unit='N', xMultiplier='k', y3Unit='N', xUnit='N', y1Multiplier='k', curveStyle='rampYValue', y2Unit='N', CurveDatas=None, **kw_args):
        ...
        #: Multiplier for Y1-axisValues are: "k", "d", "n", "M", "none", "G", "micro", "T", "c", "m", "p"
